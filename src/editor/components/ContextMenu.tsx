...
export const ContextMenu: React.FC = () => {
  ...
  const copyElementClean = useProjectStore((s) => s.copyElementClean);
  ...
  // Copy/Paste (without animations/keyframes/effects)
  menuItems.push({
    label: 'Kopieren (ohne Animationen)',
    onClick: () => {
      copyElementClean(contextMenu.elementId);
      setContextMenu(null);
    },
