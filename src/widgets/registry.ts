...
import { kvCacheWidget } from './components/KVCache';
import { kvCacheDarkWidget } from './components/KVCacheDark';
import { pageZoomWidget } from './components/PageZoom';
import { chatInferenceWidget } from './components/ChatInference';
...
registerWidget(kvCacheWidget);
registerWidget(kvCacheDarkWidget);
registerWidget(pageZoomWidget);
registerWidget(chatInferenceWidget);
